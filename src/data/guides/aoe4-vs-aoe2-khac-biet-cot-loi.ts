  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Bên Đế chế 2, phần riêng của mỗi nền văn minh tập trung ở Castle, công trình mạnh nhất trong game: đó là nơi huấn luyện quân riêng của phe, nơi nghiên cứu những công nghệ riêng mà phe khác không có, và cũng là thứ mà đối thủ muốn hạ thì phải chịu khó đầu tư đồ công thành.',
    ...
    },
    {
      ...
      paragraphs: [
        'Bên Đế chế 2, tường gỗ có ngay từ Dark Age và trả bằng gỗ, tường đá mở ở Feudal Age và trả bằng đá, còn Watch Tower thì tự bắn tên vào địch, cho dân chui vào trong thì số mũi tên bắn ra còn nhiều hơn. Vì thế, dựng vội một cái chòi ở chỗ hiểm là cách quen thuộc để mua thời gian khi bị ép sớm.',
    ...
    },
    {
      ...
      paragraphs: [
        'Nếu xếp bốn game trong dòng Đế chế theo nhịp trận, Đế chế 3 là nhanh nhất, kế đến là Đế chế 1, rồi tới Đế chế 4, còn Đế chế 2 thong thả nhất. Chơi Đế chế 2 lâu năm thì ai cũng quen cảnh đang thua vẫn gỡ lại được, vì nhịp game bên đó cho mình đủ thời gian xoay bài và đổi hướng ra quân.',
