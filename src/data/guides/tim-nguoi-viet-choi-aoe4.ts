  ...
  sections: [
    {
      ...
      paragraphs: [
        'Dòng Đế chế vui nhất là khi chơi cùng bạn bè. Với Đế chế 4, có một cộng đồng người Việt để ghép kèo, lập đội đánh 2v2, 3v3, 4v4 và trò chuyện bằng tiếng Việt giúp bạn gắn bó với game lâu hơn nhiều.',
    ...
    },
    {
      ...
      paragraphs: [
        'Đế chế 4 có các chế độ tìm trận nhanh và đấu xếp hạng, nhưng để chơi với đúng hội bạn người Việt thì Phòng tùy chỉnh (Custom) là hợp nhất: bạn tự tạo phòng, chọn bản đồ và luật, rồi mời mọi người vào chơi chung.',
    ...
    {
      heading: 'Kết nối cộng đồng Đế chế 4 Việt Nam',
      paragraphs: [
        'Cách nhanh nhất để tìm bạn chơi là tham gia Discord và Facebook Group của cộng đồng Đế chế 4 Việt Nam. Đây là nơi mọi người rủ kèo, lập đội, chia sẻ trận hay và cập nhật giải đấu.',
        'Khi mới vào, cứ mạnh dạn giới thiệu mình là người từ Đế chế 1 mới chuyển sang - cộng đồng rất sẵn lòng chỉ dẫn và rủ chơi cùng.',
      ],
    },
  ],
  related: [
