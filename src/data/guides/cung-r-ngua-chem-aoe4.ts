...
export const mobilityUnitsGuide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Bên Đế chế 1, cầm mấy quân tuyển như Hit hay Assy thì gần như mặc định lên cung R, chơi bài "hit and run" kinh điển: bắn một loạt rồi lùi, địch đuổi theo thì bắn tiếp.',
        'Sang Đế chế 4, muốn giữ đúng cảm giác đó thì đừng tìm ở cung bộ mà hãy tìm ở kỵ cung. Cầm Mông Cổ thì đời 2 đã có Mangudai, vừa chạy vừa bắn, hợp lối raid tỉa và đánh du kích. Nga chậm hơn một nhịp với Horse Archer từ đời 3, cần gom đủ số đông mới thành cung chủ lực dàn trận được. Còn Nhật có Onna-Musha, dòng kỵ cung chuyên xuyên giáp nặng.',
        'Tuy nhiên giá của kỵ cung không hề rẻ: một con Mangudai đắt gần gấp đôi cung thường, chính vì vậy chỉ cần mất vài con là thế trận hụt hẳn. Bên cạnh đó, kỵ cung khi chưa đủ đông vẫn bị kỵ nhẹ săn như thường, bởi Đế chế 4 khắc chế quân rất chặt, quân mạnh mấy cũng có khắc tinh riêng.',
      ],
    },
    {
