...
export const mobilityUnitsGuide: Guide = {
  ...
  sections: [
    {
      heading: 'Trận nào cũng là trận kỵ binh',
      paragraphs: [
        'Đế chế đánh random, vào quân nào đánh theo bài quân đó. Nhưng có một thứ không đổi là quân nào cũng mở màn bằng ngựa. Trận nào cũng là trận kỵ binh, nên trận nào cũng nhanh.',
        'Đế chế 4 nhịp chậm hơn - chuyện đó bài so sánh hai game nói rồi. Nhưng trong game vẫn có nguyên một nhóm quân giữ được cái nhịp cũ, gồm kỵ cung, kỵ nặng và lạc đà. Bài này chỉ đúng chỗ cho anh em mê đánh nhanh.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        'Vào Pal, Per là xác định đánh lạc đà. Đội lạc đà bay đi tới đâu là đội ngựa bên kia dạt tới đó.',
        'Đế chế 4 trao vai đó cho Abbasid. Camel Archer ra từ đời 2, vừa chạy vừa bắn. Camel Rider ra từ đời 3, cận chiến chuyên trị kỵ. Ngựa của đối thủ đứng gần lạc đà còn bị trừ 20% sát thương - đúng chất ngựa sợ lạc đà như bên Đế chế.',
        'Lạc đà khắc kỵ chứ không khắc bộ binh. Cầm lạc đà đấm giáo với chém là nướng quân - gặp trận đối thủ không đi ngựa thì để tiền ra quân khác.',
      ],
    },
    {
