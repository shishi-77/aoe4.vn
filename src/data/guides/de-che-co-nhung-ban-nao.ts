  ...
  sections: [
    {
      ...
      paragraphs: [
        'Với phần lớn anh em, câu rủ nhau "tối chém chế không" chỉ mang đúng một nghĩa: bản năm 1997, đánh luật đời 3 không thành. Cách gọi đó hình thành từ thời quán net và nó đúng với trải nghiệm của cả một thế hệ. Tuy nhiên, nếu bây giờ tìm cái tên ấy trên web hoặc trên một nền tảng chơi game như Steam, thứ hiện ra sẽ là một danh sách dài hơn nhiều: có bản đề số, có bản gắn thêm chữ Definitive Edition, lại có cả những cái tên nghe rất quen mà thật ra không thuộc series Đế chế.',
    ...
    },
    {
      ...
      paragraphs: [
        'Đế chế 1 ra ngày 15 tháng 10 năm 1997, do Ensemble Studios phát triển và Microsoft phát hành. Gần đúng một năm sau, ngày 31 tháng 10 năm 1998, bản mở rộng Rise of Rome bổ sung thêm nền văn minh và quân mới, trong đó có lạc đà.',
        'Ở Việt Nam, đây là bản gắn với cả một nếp chơi riêng mà không tài liệu chính thức nào ghi lại. Trước hết là luật: "đời 3 không thành", tức vào trận từ đời 3 và bỏ luôn thành với chòi ra khỏi cuộc chơi. Đây là luật do cộng đồng tự đặt chứ trong game không hề có quy định nào như vậy. Bên cạnh luật còn có kèo, tức thể thức của ván đấu mà hai bên thống nhất trước khi vào, chẳng hạn chạm 3 hay solo random. Hai thứ đó khác nhau, và người mới ngồi vào bàn mà lẫn lộn là lạc nhịp ngay ván đầu tiên.',
        'Cũng nên nhớ một chi tiết sẽ còn quay lại nhiều lần ở phần sau: Ensemble Studios, cái tên đứng sau bản này và hai bản kế tiếp, bị Microsoft công bố đóng cửa năm 2008 và giải thể đầu năm 2009. Chính vì vậy, mọi bản ra sau đó trong series đều do những studio khác tiếp quản.',
      ],
      link: {
    ...
    },
    {
      ...
      paragraphs: [
        'Age of Mythology ra mắt cuối tháng 10 năm 2002, cũng do Ensemble Studios làm, nên tuy không mang số hiệu của series chính thì nó vẫn là ruột thịt. Bản mở rộng The Titans ra ngày 30 tháng 9 năm 2003.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Đây là nhận định chứ không phải số liệu, nên xin nói luôn cả cơ sở lẫn giới hạn của nó. Trước hết là mấy thứ KHÔNG dùng làm căn cứ được, vì hai bên ngang nhau cả: chuyện bản nào ra nội dung đều hơn thì không phân định được, bởi cả Đế chế 2 lẫn Đế chế 4 đều đang được cập nhật rất dày; bảng xếp hạng thì bản nào cũng có; mặt nền tảng cũng vậy, cả hai đều đã lên máy chơi game và đều nằm trong Game Pass. Thứ Đế chế 4 thật sự có riêng chỉ là tuổi đời: nó là bản mới nhất của series, vòng đời nội dung còn dài ở phía trước. Phần còn lại thuần là quan sát về hướng đi của lớp người mới ở Việt Nam, và theo đà hiện nay thì họ đang nghiêng về cửa này.',
        'Thêm một điểm nhỏ dành riêng cho người đang cầm Đế chế 1: tốc độ game của Đế chế 4 chậm hơn bản 1997, dân và quân đều đi thong thả hơn, nên tay bạn không phải chạy gấp hơn thói quen cũ.',
