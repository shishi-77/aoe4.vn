...
export const aoe4VsAoe1Guide: Guide = {
  ...
  description:
    'AoE4 khác Đế chế thế nào? Giải thích cho người chơi Đế chế: vì sao luật đời 3 không thành không còn cần thiết, nhịp trận và cơ chế tự động, lên đời bằng landmark và khắc chế binh chủng trong Đế chế 4.',
