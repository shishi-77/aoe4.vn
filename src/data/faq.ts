...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      'Đế chế 4 (tên chính thức Age of Empires IV, viết tắt AoE4) là game chiến thuật thời gian thực phát hành năm 2021, phần kế thừa chính thức của dòng Age of Empires mà người Việt quen gọi là "Đế chế". Vẫn là thu tài nguyên, lên đời, ra quân và giao tranh như Đế chế, nhưng đồ họa, cơ chế và cân bằng hiện đại hơn nhiều.',
  },
  {
    question: 'Đế chế 4 có giống Đế chế (AoE1) không?',
    answer:
      'Giống ở tinh thần cốt lõi: thu thập tài nguyên, lên đời, xây quân và đánh nhau. Khác ở chỗ AoE4 có các nền văn minh đặc trưng rõ rệt, cơ chế địa hình và công thành sâu hơn, cùng đồ họa 3D. Người chơi Đế chế chuyển sang thường thấy quen tay chỉ sau vài trận.',
  },
  {
