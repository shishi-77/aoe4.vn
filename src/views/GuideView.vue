...
<template>
    ...
    <div class="mt-10 space-y-8">
      <section v-for="s in guide.sections" :key="s.heading">
        ...
        <RouterLink
          ...
          class="mt-3 inline-flex min-h-11 items-center text-sm font-semibold text-gold hover:underline"
        >
          {{ s.link.label }} →
        </RouterLink>
      </section>
  ...
  <div v-else class="mx-auto max-w-2xl px-4 py-32 text-center">
    ...
    <RouterLink to="/guides/" class="mt-6 inline-flex min-h-11 items-center text-cream underline">
