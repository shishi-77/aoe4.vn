# Facts sheet: aoe4-vs-aoe2-khac-biet-cot-loi

- Loại bài: `comparison` (AoE4 vs AoE2)
- Từ khóa đích: `aoe4 vs aoe2`
- Ngày soạn: 2026-08-06
- Người đọc đích: dân AoE2 (và dân Đế chế) muốn biết AoE4 khác chỗ nào trước khi thử

## Dàn ý

1. Mở bài: người chơi AoE2 lâu năm nhìn sang AoE4, cái gì mang sang được, cái gì phải học lại.
2. Lên đời: cả hai game đều 4 đời, nhưng AoE2 bấm ở nhà chính, AoE4 xây Landmark.
3. Phe: AoE2 khác nhau ở quân riêng và công nghệ riêng tại Castle; AoE4 khác nhau tận cơ chế
   (Mông Cổ không tường, Abbasid lên đời bằng công nghệ).
4. Khắc chế: AoE4 gom về tam giác giáo - kỵ - cung.
5. Tường thành và công thành: AoE2 tường gỗ từ đời 1, tường đá từ đời 2, chòi tự bắn tên;
   AoE4 tường đá chỉ đồ công thành phá được, chòi phải nâng cấp mới bắn.
6. Nhịp trận: xếp hạng tốc độ AoE3 > AoE1 > AoE4 > AoE2.
7. Chốt: ai hợp game nào, không phán game nào hơn.
...
| 7 | Mông Cổ trong AoE4 không xây được bất kỳ loại tường nào và gói được công trình để dời đi | [ĐÃ CÓ TRONG KHO] AoE4 | `aoe4-facts.md` > Mongols: "can pack up buildings and relocate... They CANNOT build ANY walls" - owner xác nhận 2026-07-07 |
| 8 | Abbasid là phe kinh tế mạnh nhất AoE4 | [ĐÃ CÓ TRONG KHO] AoE4 | `aoe4-facts.md`: "Abbasid Dynasty has the STRONGEST economy of all AoE4 civs" - owner xác nhận 2026-07-07 |
| 9 | Xếp nhịp bốn game: AoE3 > AoE1 > AoE4 > AoE2 (AoE2 thong thả nhất) | [ĐÃ CÓ TRONG KHO] AoE4 | `aoe4-facts.md` > Cross-title speed ranking - owner xác nhận 2026-07-06, "must NOT be flagged as a factual error" |
| 10 | AoE2 có 4 đời: The Dark Age, The Feudal Age, The Castle Age, The Imperial Age | [NGUỒN CHÍNH THỨC] AoE2 | https://www.ageofempires.com/learn-to-play/advancing-aoe2/ - "The Dark Age", "The Feudal Age", "The Castle Age", "The Imperial Age" |
| 11 | Lên đời trong AoE2 nghiên cứu tại nhà chính (Town Center) | [NGUỒN CHÍNH THỨC] AoE2 | cùng URL trên - "Advancing to the next Age can be done at the Town Center." |
| 12 | Muốn lên đời AoE2 phải xây ít nhất 2 công trình của đời hiện tại; riêng đời Castle có thể thay bằng một Castle | [NGUỒN CHÍNH THỨC] AoE2 | cùng URL trên - "Advancement requires you to construct at least two buildings from the current Age." + "In the Castle Age, you can either construct two buildings from the Castle Age...or construct a single Castle." |
| 13 | AoE2: tường gỗ (Palisade Wall) có từ đời 1 trả bằng gỗ, tường đá (Stone Wall) mở ở đời 2 trả bằng đá | [NGUỒN CHÍNH THỨC] AoE2 | https://www.ageofempires.com/learn-to-play/defending-your-empires-aoe2/ - "Palisade walls are available in the Dark Age at the cost of Wood, and Stone Walls become available in the Feudal Age at the cost of stone." |
...
- Số lượng nền văn minh AoE2 (trang chính thức ghi "35 different civilizations" nhưng cùng site
  còn quảng bá DLC Three Kingdoms thêm 5 phe) -> số liệu tự mâu thuẫn, KHÔNG đưa vào bài.
- Bảng khắc chế chi tiết của AoE2 (giáo khắc kỵ, skirmisher khắc cung...): các trang
  learn-to-play chính thức không nêu, hai patch note đã fetch (34055, 39284) không có dòng nào.
  -> KHÔNG viết claim khắc chế cho phía AoE2; mục khắc chế chỉ mô tả tam giác AoE4.
- Tuổi đời/đời mở của tường, Keep, ram, Mangonel, Trebuchet trong AoE4: kho ghi rõ
  "⚠️ CẦN NGƯỜI DUYỆT ... not independently verified" -> không nêu mốc đời cho đồ AoE4.
