FIXTURE ĐÔNG LẠNH từ src/data/guides/build-order-co-ban-aoe4.ts tại main - chụp lại 2026-08-08 (bản cũ nói luật Landmark tuyệt đối, đã mục sau WRITING RULE 2026-08-07; bản này thêm vế lý do cho các câu chốt gọn). Nhãn owner: đạt. Không theo dõi file gốc.
